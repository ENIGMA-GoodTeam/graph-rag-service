...
from graph_rag_service.domain.schemas.request import DocumentCreateRequest
from graph_rag_service.domain.schemas.response import (
    DocumentResponse,
...
async def list_documents(
    ...
    try:        
        ...
        total_result = connector.execute_query(count_query, {"user_id": user_id})
...
async def delete_document(
    ...
    try:
        ...
        LIMIT 1
        """
        exists = connector.execute_query(check_query, {
            "doc_id": document_id,
            "user_id": user_id
        })
        ...
        result = connector.execute_write(delete_query, {
            "doc_id": document_id,
            "user_id": user_id
        })
