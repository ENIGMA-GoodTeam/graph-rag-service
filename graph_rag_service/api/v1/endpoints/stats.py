...
from graph_rag_service.api.deps import get_connector
from graph_rag_service.domain.schemas.response import StatsResponse, GraphSchemaResponse
...
async def get_graph_schema(
    ...
    try:
        ...
        labels_result = connector.execute_query(labels_query)
        ...
        rel_result = connector.execute_query(rel_types_query)
        ...
        constraints_result = connector.execute_query(constraints_query)
        ...
        indexes_result = connector.execute_query(indexes_query)
