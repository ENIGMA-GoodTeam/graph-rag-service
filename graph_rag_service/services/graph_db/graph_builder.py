...
from graph_rag_service.services.graph_db.connector import GraphDBConnector  # ✅ Полный импорт
from graph_rag_service.services.entity_extractor.hybrid_entity_extractor import HybridEntityExtractor  # ✅ Полный импорт
