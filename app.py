...
from graph_rag_service.api.v1.router import api_router
from graph_rag_service.api.v1.middleware.setup_middleware import setup_middleware
from graph_rag_service.core.events import (
    startup_event,
    shutdown_event,
    warm_up_event,
...
from graph_rag_service.utils.logger import setup_logging
...
async def lifespan(app: FastAPI):
    ...
    app.state.connector = components["connector"]
